            ...
            <Link className="images-group" cursor="pointer"
                ...
                <Box position="relative">
                    ...
                    <Flex position="absolute" top={2} left={2} gap={2}>
                        {property.type === 'Vent' && (
                            <Tag bg="green.900" color="white" fontWeight="bold">{property.type}</Tag>
                        )}
                        {property.type === 'Location' && (
                            <Tag bg="red.600" color="white" fontWeight="bold">{property.type}</Tag>
                        )}
                    </Flex>
                    <Flex position="absolute" bottom={2} left={2}>
                        <Tag bg="white" color="black" fontWeight="bold">{property.category}</Tag>
                    </Flex>
                </Box>
            </Link>
            <Box mt={2}>
