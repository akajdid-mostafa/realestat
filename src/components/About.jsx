                ...
                <div className="relative mt-24">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mx-4">
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="font-normal text-base text-gray-600 dark:text-gray-200">
                                Nous nous engageons à offrir des prix transparents et compétitifs pour toutes nos propriétés. Notre expertise locale assure que vous bénéficiez de la meilleure valeur pour votre achat ou location.                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="font-normal text-base text-gray-600 dark:text-gray-200">
                                Notre équipe est à votre disposition pour vous aider tout au long du processus immobilier. Que vous ayez des questions ou besoin d’assistance, nous assurons un service rapide et efficace.                            </p>
                        </div>
                    </div>
                </div>
